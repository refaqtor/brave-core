...
void PublisherInfoDatabaseTest::PreparePendingContributions () {
  ...
  contribution3.category = ledger::REWARDS_CATEGORY::DIRECT_DONATION;
  ...
  contribution4.category = ledger::REWARDS_CATEGORY::DIRECT_DONATION;
...
TEST_F(PublisherInfoDatabaseTest, GetPendingContributions) {
   ...
   * Good path
  */
  brave_rewards::PendingContributionInfoList select_list;
